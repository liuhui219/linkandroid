...
export default class FacebookExample extends Component {
     ...
     fetch('https://api.thinkpage.cn/v3/weather/now.json?key=ptzo3jrfv3tq1wez&location='+this.state.location+'&language=zh-Hans&unit=c')
		  ...
		  .then((responseData) => {
              ...
              if(responseData.results[0].now['code'] == 0){
                 this.setState({images:require('./imgs/weather/0.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 1){
              	 this.setState({images:require('./imgs/weather/1.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 2){
              	 this.setState({images:require('./imgs/weather/2.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 3){
              	 this.setState({images:require('./imgs/weather/3.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 4){
              	 this.setState({images:require('./imgs/weather/4.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] == 5){
              	 this.setState({images:require('./imgs/weather/5.png'),infos:'��ת����'})
              }else if(responseData.results[0].now['code'] == 6){
              	 this.setState({images:require('./imgs/weather/6.png'),infos:'��ת����'})
              }else if(responseData.results[0].now['code'] == 7){
              	 this.setState({images:require('./imgs/weather/7.png'),infos:'�󲿶���'})
              }else if(responseData.results[0].now['code'] == 8){
              	 this.setState({images:require('./imgs/weather/8.png'),infos:'�󲿶���'})
              }else if(responseData.results[0].now['code'] == 9){
              	 this.setState({images:require('./imgs/weather/9.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 10){
              	 this.setState({images:require('./imgs/weather/10.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] == 11){
              	 this.setState({images:require('./imgs/weather/11.png'),infos:'������'})
              }else if(responseData.results[0].now['code'] == 12){
              	 this.setState({images:require('./imgs/weather/12.png'),infos:'���������б���'})
              }else if(responseData.results[0].now['code'] == 13){
              	 this.setState({images:require('./imgs/weather/13.png'),infos:'С��'})
              }else if(responseData.results[0].now['code'] == 14){
              	 this.setState({images:require('./imgs/weather/14.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] == 15){
              	 this.setState({images:require('./imgs/weather/15.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] == 16){
              	 this.setState({images:require('./imgs/weather/16.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] == 17){
              	 this.setState({images:require('./imgs/weather/17.png'),infos:'������'})
              }else if(responseData.results[0].now['code'] == 18){
              	 this.setState({images:require('./imgs/weather/18.png'),infos:'�ش�����'})
              }else if(responseData.results[0].now['code'] == 19){
              	 this.setState({images:require('./imgs/weather/19.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] ==20){
              	 this.setState({images:require('./imgs/weather/20.png'),infos:'����ѩ'})
              }else if(responseData.results[0].now['code'] == 21){
              	 this.setState({images:require('./imgs/weather/21.png'),infos:'��ѩ'})
              }else if(responseData.results[0].now['code'] == 22){
              	 this.setState({images:require('./imgs/weather/22.png'),infos:'Сѩ'})
              }else if(responseData.results[0].now['code'] == 23){
              	 this.setState({images:require('./imgs/weather/23.png'),infos:'��ѩ'})
              }else if(responseData.results[0].now['code'] == 24){
              	 this.setState({images:require('./imgs/weather/24.png'),infos:'��ѩ'})
              }else if(responseData.results[0].now['code'] == 25){
              	 this.setState({images:require('./imgs/weather/25.png'),infos:'��ѩ'})
              	 ...
              	 this.setState({images:require('./imgs/weather/27.png'),infos:'��ɳ'})
              }else if(responseData.results[0].now['code'] == 28){
              	 this.setState({images:require('./imgs/weather/28.png'),infos:'ɳ����'})
              }else if(responseData.results[0].now['code'] == 29){
              	 this.setState({images:require('./imgs/weather/29.png'),infos:'ǿɳ����'})
              }else if(responseData.results[0].now['code'] == 30){
              	 this.setState({images:require('./imgs/weather/30.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 31){
              	 this.setState({images:require('./imgs/weather/31.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 32){
              	 this.setState({images:require('./imgs/weather/32.png'),infos:'��'})
              }else if(responseData.results[0].now['code'] == 33){
              	 this.setState({images:require('./imgs/weather/33.png'),infos:'����'})
              }else if(responseData.results[0].now['code'] == 34){
              	 this.setState({images:require('./imgs/weather/34.png'),infos:'쫷�'})
              }else if(responseData.results[0].now['code'] == 35){
              	 this.setState({images:require('./imgs/weather/35.png'),infos:'�ȴ��籩'})
              }else if(responseData.results[0].now['code'] == 36){
              	 this.setState({images:require('./imgs/weather/36.png'),infos:'������'})
              }
		  })
		  .catch((error) => {
    ...
    onBackHandler = () => {
       ...
       if (this.lastBackPressed && this.lastBackPressed + 2000 >= Date.now()) {
		...
		ToastAndroid.show('�ٰ�һ���˳�Ӧ��', ToastAndroid.SHORT);
  ...
  onclick(){
    ...
    translucent:true,
      isshow: true,
      bars:'default',
      day:'����'+this.state.weekday[new Date().getDay()],
				...
				{this.state.isshow ? <Animated.View style={{opacity:this.state.opacitys,height:Dimensions.get('window').height,width:Dimensions.get('window').width,position:'absolute',top:0,left:0,backgroundColor:'rgb(230,230,230)'}}>
                     ...
                     {this.state.weathers ? <TouchableHighlight onPress={this.reloads.bind(this)} underlayColor='transparent' activeOpacity = {1} style={{position:'absolute',top:60,right:20,alignItems:'center',flexDirection:'column'}}>
	                     <View style={{alignItems:'center',flexDirection:'column'}}>
	                            ...
	                            <Text style={{fontSize:12}} allowFontScaling={false} adjustsFontSizeToFit={false}>{this.state.times}����</Text>
                     ...
                     {this.state.weathers ? <View style={{marginTop:20,flexDirection:'row',marginRight:18,width:Dimensions.get('window').width}}>
                         <View style={{flexDirection:'column',flex:1,alignItems:'flex-start',justifyContent:'flex-start',position:'absolute',top:10,left:15}}>
                            <Text style={{marginBottom:5,fontSize:12}} allowFontScaling={false} adjustsFontSizeToFit={false}>���ڳ���</Text>
                     ...
                     {this.state.weathers ? <View style={{alignItems:'center',marginTop:10}}>
                       <TouchableHighlight onPress={this.ck.bind(this)} underlayColor='transparent' activeOpacity = {1}>
                        <View style={{alignItems:'center',}}>
                          <Text style={{color:'#666',fontSize:12,}} allowFontScaling={false} adjustsFontSizeToFit={false}>�鿴����></Text>
                        </View>
                        </TouchableHighlight>
                     </View> : null}
