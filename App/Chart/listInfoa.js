							  ...
							  <ScrollView horizontal={true} ref='trueScroll' scrollEnabled ={false} showsHorizontalScrollIndicator={false}>
							     <View style={{flexDirection:'column',flex:1,borderRightWidth:1,borderColor:'#ccc'}}>
										...
										<View style={{flexDirection:'row',height:40,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
										  ...
										  <View style={{width:Dimensions.get('window').width/4,justifyContent:'center',alignItems:'center',height:40,}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >汇总</Text></View>
										</View>
									 </View>
								  ...
								  <View style={{flexDirection:'column',flex:1,borderRightWidth:1,borderColor:'#ccc'}}>
											...
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',}}>
												{lists.rw.map((info,j)=>{
													return  <View key={j} style={{width:Dimensions.get('window').width/4,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40,borderBottomWidth:1,borderColor:'#ccc',}}><Text  allowFontScaling={false} adjustsFontSizeToFit={false} >{info}</Text></View>
													  ...
													  <View style={{width:Dimensions.get('window').width/4,justifyContent:'center',alignItems:'center',height:40,borderBottomWidth:1,borderColor:'#ccc',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.rwtotal}</Text></View>
													</View>
										})}
									 ...
									 <View style={{flexDirection:'row',}}>
										 {this.state.rw.map((catenames,i)=>{
										  ...
										  <View style={{width:Dimensions.get('window').width/4,height:40,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{this.state.summary.rwtotal}</Text></View>
								  ...
								  <View style={{flexDirection:'column',flex:1,borderRightWidth:1,borderColor:'#ccc'}}>
											...
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',}}>
												{lists.day.map((info,j)=>{
													return  <View key={j}  style={{width:Dimensions.get('window').width/4,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40,borderBottomWidth:1,borderColor:'#ccc',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{info}</Text></View>
													  ...
													  <View style={{width:Dimensions.get('window').width/4,justifyContent:'center',alignItems:'center',height:40,borderBottomWidth:1,borderColor:'#ccc',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.daytotal}</Text></View>
													</View>
										})}
									 ...
									 <View style={{flex:1,flexDirection:'row',}}>
										 {this.state.rw.map((catenames,i)=>{
										  ...
										  <View style={{width:Dimensions.get('window').width/4,justifyContent:'center',alignItems:'center',height:40,borderBottomWidth:1,borderColor:'#ccc',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{this.state.summary.daytotal}</Text></View>
