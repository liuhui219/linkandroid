		           ...
		           <View style={styles.card} ref="cards">
						  ...
						  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
									<View style={{justifyContent:'center',flexDirection:'row',alignItems:'center'}}>
												<Text style={{color:'white',fontSize:18}} allowFontScaling={false} adjustsFontSizeToFit={false}>回款报表</Text>
									</View>
						  </View>
						  <View style={{flex:1,justifyContent:'center'}}>
							  ...
							  <ScrollView horizontal={true} ref='trueScroll' scrollEnabled ={false} showsHorizontalScrollIndicator={false}>
							     <View style={{flexDirection:'column',flex:1,}}>
									...
									<View style={{flexDirection:'row',height:40,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
									 <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  >现有渠道</Text></View>
									 <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  >新增渠道</Text></View>
									 <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',height:40,borderRightWidth:1,borderColor:'#ccc'}}><Text allowFontScaling={false} adjustsFontSizeToFit={false}  >汇总</Text></View>
									</View>
								 </View>
								  <View style={{flexDirection:'column',flex:1,}}>
									<View style={{justifyContent:'center',alignItems:'center',height:40,borderBottomWidth:1,borderColor:'#ccc',borderRightWidth:1,borderColor:'#ccc'}}>
								  ...
								  <View style={{flexDirection:'column',flex:1,borderRightWidth:1,borderColor:'#ccc'}}>
										...
										<View style={{flexDirection:'row',height:40,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
										  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >年度汇总</Text></View>
                               ...
                               <View style={{flexDirection:'column',width:130,borderRightWidth:1,borderColor:'#ccc',borderLeftWidth:1,borderColor:'#ccc'}}>
							     <View style={{flexDirection:'column',flex:1}}>
									...
									<View style={{flexDirection:'row',height:40,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
									  ...
									  <View style={{flex:1,justifyContent:'center',alignItems:'center',bheight:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >总监</Text></View>
									</View>
								 </View>
								 <View style={{flex:1,flexDirection:'column',}}>
								    {this.state.list.map((lists,i)=>{
										return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
												  ...
												  <View style={{flex:1,justifyContent:'center',alignItems:'center',height:40,}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{flex:1,textAlign:'center',paddingTop:10,paddingBottom:10}}>{lists.l_name}</Text></View>
												</View>
									})}
							  ...
							  <ScrollView horizontal={true} onScroll={this.onScroll.bind(this)}>
								  ...
								  <View style={{flexDirection:'column',width:Dimensions.get('window').width,}}>
									 ...
									 <View style={{flex:1,flexDirection:'column',}}>
										{this.state.list.map((lists,i)=>{
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
													  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.day[0]}</Text></View>
													  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.day[1]}</Text></View>
													  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',height:40,borderRightWidth:1,borderColor:'#ccc'}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.day[2]}</Text></View>
								  ...
								  <View style={{flexDirection:'column',width:Dimensions.get('window').width,}}>
									 ...
									 <View style={{flex:1,flexDirection:'column',}}>
										{this.state.list.map((lists,i)=>{
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
													  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.month[0]}</Text></View>
													  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.month[1]}</Text></View>
													  <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',height:40,borderRightWidth:1,borderColor:'#ccc'}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.month[2]}</Text></View>
													</View>
										})}
								  ...
								  <View style={{flexDirection:'column',flex:1,borderRightWidth:1,borderColor:'#ccc'}}>
									 ...
									 <View style={{flex:1,flexDirection:'column',}}>
										{this.state.list.map((lists,i)=>{
											return <View key={i} style={{flexDirection:'row',flex:1,justifyContent:'center',alignItems:'center',borderBottomWidth:1,borderColor:'#ccc',}}>
											          <View style={{width:Dimensions.get('window').width/3,justifyContent:'center',alignItems:'center',borderRightWidth:1,borderColor:'#ccc',height:40}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} >{lists.year}</Text></View>
