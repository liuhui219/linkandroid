  ...
  _startTime(){
    ...
    _submit(){
      ...
      if(this.state.result == '请选择(必填)'){
  			...
  			ToastAndroid.show('结束时间必须大于开始时间', ToastAndroid.SHORT)
  			return false;
        ...
        ToastAndroid.show('请选择审核人', ToastAndroid.SHORT)
  			return false;
      }else if(this.trim(this.state.textaerax) == ''){
        ToastAndroid.show('请填写出差地点', ToastAndroid.SHORT)
  			return false;
        ...
        fetch('' + this.state.domain + '/index.php?app=Kaoqin&m=KaoqinReportApi&a=add_kaoqin_record&access_token=' + this.state.token + '', {
         ...
         body: this.toQueryString({
              ...
              'cc_address':this.state.textaerax
         })
       })
       .then(function (response) {
         return response.json();
           ...
           return (
		           ...
		           <View style={styles.card}>
    						  ...
    						  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
    									<View style={{justifyContent:'center',flexDirection:'row',alignItems:'center'}}>
    												<Text style={{color:'white',fontSize:18}} allowFontScaling={false} adjustsFontSizeToFit={false}>出差申请</Text>
    									</View>
    						  </View>
    						  <View style={{flex:1,justifyContent:'center'}}>
              ...
              <KeyboardAvoidingView behavior='padding' style={{flex:1}}>
                ...
                <View style={{flexDirection:'row',backgroundColor:'#fff',alignItems:'flex-start',justifyContent:'center',borderTopWidth:1,borderBottomWidth:1,borderColor:'#dcdcdc',marginTop:15,paddingLeft:10,}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,color:'#333', paddingTop:5,}}>出差地点</Text>
                   <View style={{flex:1,marginLeft:15,}}>
                     <TextInput
                       onChangeText={(textaerax) => this.setState({textaerax})}
                       multiline={true}
                       numberOfLines={2}
                       placeholderTextColor={'#ccc'}
                ...
                <View style={{flexDirection:'row',backgroundColor:'#fff',alignItems:'flex-start',justifyContent:'center',borderTopWidth:1,borderBottomWidth:1,borderColor:'#dcdcdc',marginTop:15,paddingLeft:10,}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,color:'#333', paddingTop:5,}}>出差原因</Text>
                   <View style={{flex:1,marginLeft:15,}}>
                     <TextInput
