...
import OverProject from './OverProject';
      		           ...
      		           <View style={styles.card}>
            						  ...
            						  <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
            									<View style={{justifyContent:'center',flexDirection:'row',alignItems:'center'}}>
            												<Text style={{color:'white',fontSize:18}} allowFontScaling={false} adjustsFontSizeToFit={false}>全部项目</Text>
            									</View>
            						  </View>
            						  <View style={{flex:1,justifyContent:'center'}}>
                      ...
                      <ScrollableTabView
              				...
              				>
              				  <View  style={{marginTop:50,flex:1,}} tabLabel='进行中'>
              				     <AllProject navigator = {this.props.navigator} {...this.props} url='/index.php?app=Pmanager&m=Allpro&a=project_list'/>
              				  </View>
              				  <View style={{marginTop:50,flex:1,}} tabLabel='未完成'>
              					  <NoProject navigator = {this.props.navigator} {...this.props} url='/index.php?app=Pmanager&m=Allpro&a=project_list'/>
              				  </View>
              				  <View style={{marginTop:50,flex:1,}} tabLabel='已完成'>
              					  <OverProject navigator = {this.props.navigator} {...this.props} url='/index.php?app=Pmanager&m=Allpro&a=project_list'/>
              				  </View>
              				</ScrollableTabView>
